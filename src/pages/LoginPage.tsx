        ...
        <>
            ...
            <section className={`${styles.paddingX} ${styles.paddingY} flex flex-row max-h-screen`}>
                <motion.div 
                    ...
                    className="hidden lg:block my-auto lg:2/3 xl:w-1/2 2xl:w-3/5 3xl:w-2/4 mt-32 xl:mt-28 2xl:mt-12">
                    <img src={loginIlustration} alt="" className="lg:w-4/5 2xl:w-3/4" />
                </motion.div>
                <motion.div
                    initial={{ opacity: 0, scale: 0.2 }}
                    animate={{ opacity: 1, scale: 1 }} 
                    ...
                    className="w-full lg:w-3/4 xsm:pt-32 sm:pt-44 md:pt-32">
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-4xl h-16 mt-4 bg-gradient-to-r from-blue-500 to-green-300 text-transparent bg-clip-text font-medium">
